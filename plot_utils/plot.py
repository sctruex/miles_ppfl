...
def main():
    folder = "./"
    exp_fname = "fmnist_clip_schedule_params:initial_clip_clip_schedule_params:decay_rate_clip_schedule_params:decay_rounds_full_results_df_2.csv"
    plot_name = "fmnist_clip_scheduler_05"
    ...
    exp_var_lsts = {
        "clip_schedule_params/initial_clip": [0.1, 0.15, 0.25, 0.5, 1.],
        "clip_schedule_params/decay_rate": [0.65, 0.75, 0.85, 0.95],
        "clip_schedule_params/decay_rounds": [1, 3, 5, 8]
    }
    plot_avgs = True
    collected_metrics = ['sparse_categorical_accuracy',
                         'sparse_categorical_crossentropy']

    selection_tuples = [
        ("clip_schedule_params/initial_clip", 0.5),
        # ("clip_schedule_params/decay_rate", 0.65),
        ("clip_schedule_params/decay_rounds", 3)
    ]
    top_only = True
