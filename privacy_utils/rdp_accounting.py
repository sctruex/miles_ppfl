...
def test(D,N,k,R,mult):
    q = k/N
    eps_str = tfp.privacy.analysis.compute_dp_sgd_privacy_lib.compute_dp_sgd_privacy_statement(
        number_of_examples=D//N,
        batch_size=D//N,
        num_epochs=q*R,
...
if __name__=="__main__":
    ...
    num_rounds = 100
    noise_mult=0.08
    print(test(D=size_of_data,N=num_clients,k=num_per_round,R=num_rounds,mult=noise_mult))